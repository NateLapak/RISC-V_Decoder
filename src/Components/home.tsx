                ...
                <form className="home-form w-full max-w-lg" onSubmit={handleSubmit}>
                 ...
                 {result && (
                    <div className="mt-4 p-4 bg-gray-100 border rounded">
                        <h3 className="text-lg font-bold text-gray-800">RISC-V instruction: {instruction} </h3>
                        <h3 className="text-lg font-bol text-gray-800">Decoded Instruction: {result}</h3>
                    </div>
                )}
